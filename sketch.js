...
var bronzeM,bronze,goldM,gold,silverM,silver;
var score = 0;
var gameOverImg,restartImg
var jumpSound , checkPointSound, dieSound

function preload(){
  silverM = loadImage("silverMedal.png");
  bronzeM = loadImage("bronzeMedal.png");
  goldM = loadImage("goldMedal.png");
...
function setup() {
 ...
 console.log(message);
  ...
  backgroundbg = createSprite(200,348,600,600);
  backgroundbg.addImage("background", background1);
  backgroundbg.x = backgroundbg.width /2;
  backgroundbg.scale = 2;
  
  silver = createSprite(300,250,150,150);
  silver.addImage("SilverMedal", silverM);
  silver.scale = 0.5;

  bronze = createSprite(300,250,150,150);
  bronze.addImage("BronzeMedal", bronzeM);
  bronze.scale = 0.5;

  gold = createSprite(300,250,150,150);
  gold.addImage("GoldMedal", goldM);
  gold.scale = 0.5;
...
function draw() {
  ...
  fill("red");
  textSize(30);
  text("C I T Y    R U N N E R",160,40);
  stroke("black")
  strokeWeight(8)
  fill("red");
  textSize(20);
  ...
  fill("white");
  textSize(30);
  text("Earn  Points  To  Get  Medals.",110,320);
  if(keyDown("enter")){
  gameState = "play";
  ...
  if(gameState === "play"){
   ...
   //gameOver.visible = false;
    ...
    backgroundbg.velocityX = -(4+3/100);
    //move the ground
    ground.velocityX = -(4+3/100);

    Man.depth = backgroundbg.depth;
    Man.depth +=1; 

    ground.depth = backgroundbg.depth;
    ground.depth +=1;

    cloudsGroup.depth = backgroundbg.depth;
    cloudsGroup.depth +=1;

    obstaclesGroup.depth = backgroundbg.depth;
    obstaclesGroup.depth +=1;

    diamondGroup.depth = backgroundbg.depth;
    diamondGroup.depth +=1;
...
function createDiamond() {
  ...
  diamond.y = (Math.round(random(300, 400)));
